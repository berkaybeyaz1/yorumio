	...
	$.fn.extend({
        blurjs: function(options) {
            ...
            function svg(amt) {
                ...
                $('body').append('<svg id="blurjs-'+amt+'"><filter id="blur'+amt+'px" color-interpolation-filters="sRGB"><feGaussianBlur in="SourceGraphic" stdDeviation="'+amt+'" edgeMode="duplicate"></feGaussianBlur><feComponentTransfer><feFuncA type="discrete" tableValues="1 1" /></feComponentTran</filter></svg>');
            }
